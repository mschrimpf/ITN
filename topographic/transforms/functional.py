...
def resize(img, size, interpolation=Image.BILINEAR, match_big=False):
    ...
    Args:
        ...
        size (sequence or int): Desired output size. If size is a sequence like
            ...
            match_big will determine the edge of the image to be matched to this number maintaing
            the aspect ratio. default is to rescale to small edge. i.e if height > width,
